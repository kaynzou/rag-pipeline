...
the retrieved context and cite sources. Uses Claude by default.
"""
...
class Generator:
    """
    Grounded generation using Claude (or compatible API).

    Builds a prompt that constrains the model to answer only from
    the provided context and cite its sources.
    """
